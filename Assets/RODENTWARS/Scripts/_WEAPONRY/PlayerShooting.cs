...
namespace X23
{
    ...
    void Update() {
        ...
        if (piercing & bounce) {
            ...
            pierceImage.color = bulletColors[3];
				...
				ParticleSystem.MainModule psmain = gunParticles.main;
    ...
    void Shoot() {
        ...
        gunParticles.Stop();
				ParticleSystem.MainModule psmain = gunParticles.main;
				psmain.startSize = 1 + (0.1f * (numberOfBullets - 1));
        ...
        shootRay.direction = transform.forward;
			...
			Quaternion rot = goCamera.transform.rotation; //transform.rotation;// * Quaternion.AngleAxis(angle, Vector3.up);
