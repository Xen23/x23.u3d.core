...
namespace XenTek.Editor
{
    ...
    public class XenTekUnityConfigDataSO : ScriptableObject
    {
        // Singleton-like access to the settings instance
        private static XenTekUnityConfigDataSO instance;
        public static XenTekUnityConfigDataSO Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = Resources.Load<XenTekUnityConfigDataSO>("XenTekUnityConfigData");
                    if (instance == null)
                    {
        ...
        [Tooltip("Name of the active project (e.g., PennyArcade)")]
        public string projectName = "PennyArcade";
        ...
        public string defaultEditorScene = "Assets/Scenes/MainMenu.unity";
        ...
        public void ResetToDefaults()
        {
            ...
            defaultEditorScene = "Assets/Scenes/MainMenu.unity";
        }
        ...
        private void OnValidate()
        {
            ...
            {
                Debug.LogWarning("Project name is empty in XenTekUnityConfigDataSO.");
            }
            if (string.IsNullOrEmpty(masterServerUrl))
            {
                Debug.LogWarning("Master server URL is empty in XenTekUnityConfigDataSO.");
            }
        }
    }
}