...
namespace Xen23.Arcade.UI
{
    public class MainMenuController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (Resources.Load<StyleSheet>("Arcade Styles") is StyleSheet ussAsset)
            {
        ...
        private void Start()
        {
            ...
            if (backend != null)
            {
                backend.CheckForUpdates("Arcade", result => Debug.Log($"Update check: {result}"));
            }
        }
        ...
        private void OnEnable()
        {
            if (inputActions != null)
            {
                ...
                selectAction = inputActions.FindAction("Click");
